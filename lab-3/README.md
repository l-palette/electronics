...
### Зарегистрированные осциллограммы
![Выходные характеристики](_assets/img_2.jpg)

Характеристики зарисованы для трёх фиксированных значений тока базы:
- $ I_{б1} = 0 $ (режим отсечки)
- $ I_{б2} = 0.1\ \text{мА} $ (половина максимального тока усиления)
- $ I_{б3} = 0.2\ \text{мА} $ (граница активной области и насыщения)
